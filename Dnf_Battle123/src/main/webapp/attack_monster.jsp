...
<%
    ...
    // 세션에 저장해둔 캐릭터 객체를 꺼내옴
    캐릭터 myChar = (캐릭터) session.getAttribute("myCharacter");

    if ("attack".equals(action)) {
        // 다이어그램 명세대로 파라미터 2개(ID, 캐릭터객체)를 전달하여 호출
...
<body>
    ...
    <% } else { %>
        ...
        <br><br>
        <hr>
        <a href="add_item.jsp?playerId=<%= playerId %>">🎁 아이템 획득하러 가기 (인벤토리 관리)</a> | 
